...
try
{
	...
	<tr style="border: 1px solid black;"><th style="border: 1px solid black;">Flight Name</th><th style="border: 1px solid black;">From</th><th style="border: 1px solid black;">To</th><th style="border: 1px solid black;">Date</th></tr> <%
	do
	{ %>
	<tr style="border: 1px solid black;"><td style="border: 1px solid black;"><%= rs.getString(2) %></td><td style="border: 1px solid black;"><%= rs.getString(3) %></td><td style="border: 1px solid black;"><%= rs.getString(4) %></td><td style="border: 1px solid black;"><%= rs.getString(5) %></td></tr><% 
	}while(rs.next());%>
